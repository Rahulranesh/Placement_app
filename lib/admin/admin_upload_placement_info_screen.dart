...
class AdminUploadPlacementInfoScreen extends StatefulWidget {
  ...
  const AdminUploadPlacementInfoScreen({this.uploadOnly = false, Key? key}) : super(key: key);

  @override
  _AdminUploadPlacementInfoScreenState createState() => _AdminUploadPlacementInfoScreenState();
}

class _AdminUploadPlacementInfoScreenState extends State<AdminUploadPlacementInfoScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: NeumorphicContainer(
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  NeumorphicTextField(label: 'Company Name', onSaved: (value) => companyName = value.trim()),
                  SizedBox(height: 15),
                  NeumorphicTextField(label: 'Eligibility Criteria', onSaved: (value) => eligibility = value.trim()),
                  SizedBox(height: 15),
