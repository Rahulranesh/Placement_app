...
class PlacementInfoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // Removed the notification button for student mode
      appBar: CustomAppBar(title: 'Placement Info', showNotificationButton: false),
      body: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.isEmpty)
            return Center(child: Text('No placement info found.'));
